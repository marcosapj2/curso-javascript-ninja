(function () {
  ...
  */
  ...
  console.log(marissandra.getFullName());
  // ?
  ...
  */
  ...
  console.log(marissandra.getFullName() + ' tem ' + marissandra.getAge() + ' anos.');
  // ?
  ...
  */
  ...
  console.log('10 anos se passaram!');

  marcos.addAge(10);
  larissa.addAge(10);
  marissandra.addAge(10);

  console.log(marcos.getFullName() + ' agora tem ' + marcos.getAge() + ' anos.');
  console.log(larissa.getFullName() + ' agora tem ' + larissa.getAge() + ' anos.');
  console.log(marissandra.getFullName() + ' agora tem ' + marissandra.getAge() + ' anos.');
